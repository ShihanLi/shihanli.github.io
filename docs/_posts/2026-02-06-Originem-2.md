...
<div style="display: flex; justify-content: center; gap: 10px; margin: 2rem 0; width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; padding: 0 20px; box-sizing: border-box;">
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/homescreen-update.PNG" width="240" alt="Dashboard"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Updated homescreen</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking2.PNG" width="240" alt="Exercise 1"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Ranked by mastery</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking3.PNG" width="240" alt="Exercise 2"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Ranked by subjective difficulty</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking4.png" width="240" alt="Topics"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Ranked by next due (note how long!)</figcaption>
  </figure>
</div>

But whatever marginal effectiveness this advanced N+1 algorithm brings over simply going down a word frequency list is imperceptible. Before learning the first 1000 most common words, just learning the next word is arguably maximally efficient already. After the 1000 words, the benefit of learning another word drops compared to learning word order and word forms (conjugation and tenses), and the rote memorization of flashcards gets boring. Mathematically improving the efficiency of a flashcard app won't help getting a better balance between learning important things and staying engaged in the process.
...
<div style="display: flex; justify-content: center; gap: 10px; margin: 2rem 0; width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; padding: 0 20px; box-sizing: border-box;">
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking1.PNG" width="240" alt="Dashboard"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Some formalities</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking2.PNG" width="240" alt="Exercise 1"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Conversation flows</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking3.PNG" width="240" alt="Exercise 2"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Misinterpreting book name</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/speaking4.png" width="240" alt="Topics"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Drill pronunciation</figcaption>
  </figure>
</div>
...
It all sounds simple and straightforward, but the experience was less than satisfactory. I learned that the transcription process wasn't error-tolerant, and error tolerance is essential for being learning friendly. The LLM was bad at recognizing beginner, accented speech correctly or detecting when I switched languages mid sentence to compensate for missing vocabulary, resulting in speech to text output that was mostly gibberish. This was frustrating from a learning perspective and, surprisingly, an emotional one as well. It recreated the same feeling of discomfort and inadequacy that my ego wants to avoid when practicing with a real person.
...
Then I stumbled onto the other form of output - writing. I had wanted to write about whatever comes to mind througout the day. Right after I send an email, I often think if I could have written it in French. Or I'll try to describe what I'm planning for the evening or the weekend. It's much lower effort, almost equivalent to a Google search, and it has none of the problems the speaking module had. 

<div style="display: flex; justify-content: center; gap: 10px; margin: 2rem 0; width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; padding: 0 20px; box-sizing: border-box;">
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/writing1.PNG" width="240" alt="Dashboard"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Learn from feedback</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/writing2.PNG" width="240" alt="Exercise 1"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Cloze flashcard added</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/writing3.PNG" width="240" alt="Exercise 2"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Flashcard front</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center;">
    <img src="/assets/originem1/writing4.png" width="240" alt="Topics"/>
    <figcaption style="margin-top: 8px; font-size: 0.9em; color: #666;">Flashcard back</figcaption>
  </figure>
</div>
